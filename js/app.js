(() => {
    ...
    (() => {
        ...
        if (document.querySelector(".sub-swiper")) new core(".sub-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".hot-deals-swiper")) new core(".hot-deals-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
            ...
            slidesPerView: 1,
            navigation: {
                prevEl: ".hot-deals-button-prev",
                nextEl: ".hot-deals-button-next"
            }
        });
        if (document.querySelector(".testimonials-swiper")) new core(".testimonials-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
        ...
        if (document.querySelector(".new-arrivals-swiper")) new core(".new-arrivals-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
        ...
        if (document.querySelector(".best-sellers-swiper")) new core(".best-sellers-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
        ...
        if (document.querySelector(".featured-products-swiper")) new core(".featured-products-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
        ...
        if (document.querySelector(".recommented-swiper")) new core(".recommented-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
            ...
            navigation: {
                prevEl: ".recommented-button-prev",
                nextEl: ".recommented-button-next"
            }
        });
        if (document.querySelector(".product-categories-swiper")) new core(".product-categories-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
        ...
        if (document.querySelector(".brands-swiper")) new core(".brands-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 0,
            ...
            navigation: {
                prevEl: ".brands-parters-prev",
                nextEl: ".brands-parters-next"
            }
        });
        if (document.querySelector(".related-swiper")) new core(".related-swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            loop: true,
        ...
        if (document.querySelector(".single-product-swiper")) var mySwiper = new core(".single-product-swiper", {
        ...
        if (document.querySelector(".single-product-swiper2")) new core(".single-product-swiper2", {
            modules: [ Navigation, Thumb ],
            navigation: {
        ...
        if (iconMenu) iconMenu.addEventListener("click", (function(e) {
            ...
            departmentsSub.classList.remove("sub-menu__list-active");
            arrowActive.classList.remove("menu-link__arrow-active");
        }));
        const departments = document.querySelector(".menu__link");
        const departmentsSub = document.querySelector(".sub-menu__list");
        const arrowActive = document.querySelector(".menu-link__arrow");
        if (departments) departments.addEventListener("click", (function(e) {
            departmentsSub.classList.toggle("sub-menu__list-active");
            arrowActive.classList.toggle("menu-link__arrow-active");
        }));
        function getTimeRemaining(endtime) {
            var t = Date.parse(endtime) - Date.parse(new Date);
            var seconds = Math.floor(t / 800 % 60);
            var minutes = Math.floor(t / 800 / 60 % 60);
            var hours = Math.floor(t / (800 * 60 * 60) % 24);
            var days = Math.floor(t / (800 * 60 * 60 * 24));
            return {
                total: t,
                days,
                hours,
        ...
        function initializeClock(id, endtime) {
            ...
            updateClock();
            var timeinterval = setInterval(updateClock, 800);
        }
        var deadline = "January 01 2018 00:00:00 GMT+0300";
        deadline = new Date(Date.parse(new Date) + 15 * 24 * 60 * 60 * 800);
        if (document.querySelector("#countdown")) initializeClock("countdown", deadline);
        const quantity = function() {
            let quantityInput = document.querySelectorAll(".changer-quantity__quantity");
            const changerQuantityPlusBtn = document.querySelectorAll(".changer-quantity__button-plus");
            let changerDataName;
            changerQuantityPlusBtn.forEach((QuantityPlusBtn => {
                QuantityPlusBtn.addEventListener("click", (function() {
                    changerDataName = this.getAttribute("data-calc-name");
                    function productData(changerDataName) {
                        quantityInput.forEach((quantityInpt => {
                            if (quantityInpt.classList.contains(changerDataName)) {
                                let qty = parseInt(quantityInpt.value);
                                if (quantityInpt.value < 8 || 8 === quantityInpt.value) qty += 1;
                                quantityInpt.value = qty;
                            }
                        }));
                    }
                    productData(changerDataName);
                }));
            }));
            const changerQuantityMinusBtn = document.querySelectorAll(".changer-quantity__button-minus");
            changerQuantityMinusBtn.forEach((QuantityMinusBtn => {
